    ...
    <div className="flex flex-row items-start justify-between bg-[#1F2937] px-5 py-24 lg:flex-col lg:items-center">
      <div className="grid w-[1280px] items-start justify-between gap-4 text-white lg:grid-cols-4">
        <div className="flex items-center">
          <Link
            href={"/"}
            className="rounded-full border-b-4 border-yellow-500 bg-white px-9 py-6"
          >
            <Image
        ...
        <div className="flex flex-col">
          <div>
            ...
            <p className="text-gray-400">
              Desa/Kelurahan Cimanggis, Kec. Bojong Gede,
            </p>
      ...
      <div className="mt-8 flex w-[1280px] flex-col items-start justify-between gap-10 border-white/20 px-10 pt-6 lg:flex-row lg:border-t lg:px-0">
        <p className="text-sm text-gray-400">
          {new Date().getFullYear()} - PT Akademi Ath Thibbul Badil, All rights
          reserved
        </p>
        <div className="flex flex-row gap-8">
          <Link
            href={"https://www.facebook.com/profile.php?id=100087710929348"}
            target="_blank"
          ...
          <Link
            href={"https://www.instagram.com/ith.bi/"}
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <Link
            href={
              "https://api.whatsapp.com/send/?phone=628996514008&text&type=phone_number&app_absent=0"
            }
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <Link
            href={"https://www.youtube.com/@ithbi"}
            target="_blank"
            rel="noopener noreferrer"
          >
